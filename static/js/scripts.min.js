if(function(t, e) {
		...
		function a() {
			(it.addEventListener || "load" === t.event.type || "complete" === it.readyState) && (r(), ht.ready())
		}
		...
		function l(t, e, i) {
			if(void 0 === i && 1 === t.nodeType) {
				...
				if("string" == typeof(i = t.getAttribute(n))) {
					try {
						i = "true" === i || "false" !== i && ("null" === i ? null : +i + "" === i ? +i : At.test(i) ? ht.parseJSON(i) : i)
					} catch(t) {}
					ht.data(t, e, i)
				} else i = void 0
			}
		...
		function u(t, e, i, n) {
			if($t(t)) {
				var o, s, r = ht.expando,
					...
					l = a ? ht.cache : t,
					c = a ? t[r] : t[r] && r;
				if(c && l[c] && (n || l[c].data) || void 0 !== i || "string" != typeof e) return c || (c = a ? t[r] = et.pop() || ht.guid++ : r), l[c] || (l[c] = a ? {} : {
					toJSON: ht.noop
				}), "object" != typeof e && "function" != typeof e || (n ? l[c] = ht.extend(l[c], e) : l[c].data = ht.extend(l[c].data, e)), s = l[c], n || (s.data || (s.data = {}), s = s.data), void 0 !== i && (s[ht.camelCase(e)] = i), "string" == typeof e ? null == (o = s[e]) && (o = s[ht.camelCase(e)]) : o = s, o
			}
		}
		...
		function d(t, e, i) {
			if($t(t)) {
				...
				if(r[a]) {
					...
					}(i || (delete r[a].data, c(r[a]))) && (s ? ht.cleanData([t], !0) : ut.deleteExpando || r != r.window ? delete r[a] : r[a] = void 0)
				}
			}
		}
		...
		function f(t, e) {
			...
			if(!s)
				for(s = [], i = t.childNodes || t; null != (n = i[o]); o++) !e || ht.nodeName(n, e) ? s.push(n) : ht.merge(s, f(n, e));
		...
		function v(t, e, i, n, o) {
			for(var s, r, a, l, c, u, d, h = t.length, v = p(e), y = [], w = 0; h > w; w++)
				...
				for(l = l || v.appendChild(e.createElement("div")), c = (Ht.exec(r) || ["", ""])[1].toLowerCase(), d = qt[c] || qt._default, l.innerHTML = d[1] + ht.htmlPrefilter(r) + d[2], s = d[0]; s--;) l = l.lastChild;
				if(!ut.leadingWhitespace && Wt.test(r) && y.push(e.createTextNode(Wt.exec(r)[0])), !ut.tbody)
					for(s = (r = "table" !== c || Bt.test(r) ? "<table>" !== d[1] || Bt.test(r) ? 0 : l : l.firstChild) && r.childNodes.length; s--;) ht.nodeName(u = r.childNodes[s], "tbody") && !u.childNodes.length && r.removeChild(u);
			...
			for(l && v.removeChild(l), ut.appendChecked || ht.grep(f(y, "input"), m), w = 0; r = y[w++];)
				if(n && ht.inArray(r, n) > -1) o && o.push(r);
				else if(a = ht.contains(r.ownerDocument, r), l = f(v.appendChild(r), "script"), a && g(l), i)
		...
		function D(t, e, i, n) {
			...
			if(g || d > 1 && "string" == typeof p && !ut.checkClone && ee.test(p)) return t.each(function(o) {
				var s = t.eq(o);
				g && (e[0] = p.call(this, o, s.html())), D(s, e, i, n)
			});
			if(d && (c = v(e, t[0].ownerDocument, !1, t, n), o = c.firstChild, 1 === c.childNodes.length && (c = o), o || n)) {
				for(r = (a = ht.map(f(c, "script"), T)).length; d > u; u++) s = c, u !== h && (s = ht.clone(s, !0, !0), r && ht.merge(a, f(s, "script"))), i.call(t[u], s, u);
				if(r)
					for(l = a[a.length - 1].ownerDocument, ht.map(a, _), u = 0; r > u; u++) s = a[u], Ft.test(s.type || "") && !ht._data(s, "globalEval") && ht.contains(l, s) && (s.src ? ht._evalUrl && ht._evalUrl(s.src) : ht.globalEval((s.text || s.textContent || s.innerHTML || "").replace(ne, "")));
				c = o = null
			}
			return t
		}
		...
		function E(t, e, i) {
			for(var n, o = e ? ht.filter(e, t) : t, s = 0; null != (n = o[s]); s++) i || 1 !== n.nodeType || ht.cleanData(f(n)), n.parentNode && (i && ht.contains(n.ownerDocument, n) && g(f(n, "script")), n.parentNode.removeChild(n));
			return t
		}
		...
		function $(t) {
			var e = it,
				i = re[t];
			return i || ("none" !== (i = N(t, e)) && i || (se = (se || ht("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), (e = (se[0].contentWindow || se[0].contentDocument).document).write(), e.close(), i = N(t, e), se.detach()), re[t] = i), i
		}
		...
		function O(t, e) {
			for(var i, n, o, s = [], r = 0, a = t.length; a > r; r++)(n = t[r]).style && (s[r] = ht._data(n, "olddisplay"), i = n.style.display, e ? (s[r] || "none" !== i || (n.style.display = ""), "" === n.style.display && Lt(n) && (s[r] = ht._data(n, "olddisplay", $(n.nodeName)))) : (o = Lt(n), (i && "none" !== i || !o) && ht._data(n, "olddisplay", o ? i : ht.css(n, "display"))));
		...
		function P(t, e, i, n, o) {
			for(var s = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > s; s += 2) "margin" === i && (r += ht.css(t, i + Pt[s], !0, o)), n ? ("content" === i && (r -= ht.css(t, "padding" + Pt[s], !0, o)), "margin" !== i && (r -= ht.css(t, "border" + Pt[s] + "Width", !0, o))) : (r += ht.css(t, "padding" + Pt[s], !0, o), "padding" !== i && (r += ht.css(t, "border" + Pt[s] + "Width", !0, o)));
			return r
		}
		...
		function L(t, e, i) {
			...
			if(0 >= o || null == o) {
				...
				n = r && (ut.boxSizingReliable() || o === t.style[e]), o = parseFloat(o) || 0
			}
		...
		function F(t, e, i) {
			for(var n, o = (R.tweeners[e] || []).concat(R.tweeners["*"]), s = 0, r = o.length; r > s; s++)
		...
		function W(t, e) {
			var i, n, o, s, r;
			for(i in t)
				if(n = ht.camelCase(i), o = e[n], s = t[i], ht.isArray(s) && (o = s[1], s = t[i] = s[0]), i !== n && (t[n] = s, delete t[i]), (r = ht.cssHooks[n]) && "expand" in r) {
		...
		function R(t, e, i) {
			var n, o, s = 0,
				...
				l = function() {
					if(o) return !1;
					for(var e = Ce || z(), i = Math.max(0, c.startTime + c.duration - e), n = 1 - (i / c.duration || 0), s = 0, r = c.tweens.length; r > s; s++) c.tweens[s].run(n);
			...
			for(W(u, c.opts.specialEasing); r > s; s++)
				if(n = R.prefilters[s].call(c, t, u, c.opts)) return ht.isFunction(n.stop) && (ht._queueHooks(c.elem, c.opts.queue).stop = ht.proxy(n.stop, n)), n;
		...
		function K(t, e, i, n) {
			...
			if(ht.isArray(e)) ht.each(e, function(e, o) {
				i || ti.test(t) ? n(t, o) : K(t + "[" + ("object" == typeof o && null != o ? e : "") + "]", o, i, n)
			});
		...
		ht.fn = ht.prototype = {
			...
			for("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" == typeof r || ht.isFunction(r) || (r = {}), a === l && (r = this, a--); l > a; a++)
				if(null != (o = arguments[a]))
					for(n in o) t = r[n], i = o[n], r !== i && (c && i && (ht.isPlainObject(i) || (e = ht.isArray(i))) ? (e ? (e = !1, s = t && ht.isArray(t) ? t : []) : s = t && ht.isPlainObject(t) ? t : {}, r[n] = ht.extend(c, s, i)) : void 0 !== i && (r[n] = i));
			return r
		}, ht.extend({
		...
		var vt = function(t) {
			function e(t, e, i, n) {
				...
				if(!n && ((e ? e.ownerDocument || e : z) !== $ && N(e), e = e || $, I)) {
					if(11 !== g && (d = gt.exec(t)))
						if(o = d[1]) {
							if(9 === g) {
								if(!(r = e.getElementById(o))) return i;
								if(r.id === o) return i.push(r), i
							} else if(f && (r = f.getElementById(o)) && L(e, r) && r.id === o) return i.push(r), i
						} else {
					...
					if(w.qsa && !q[t + " "] && (!O || !O.test(t))) {
						if(1 !== g) f = e, p = t;
							...
							for((a = e.getAttribute("id")) ? a = a.replace(vt, "\\$&") : e.setAttribute("id", a = j), s = (h = T(t)).length, c = ut.test(a) ? "#" + a : "[id='" + a + "']"; s--;) h[s] = c + " " + u(h[s]);
			...
			function d(t, e, i) {
				...
				return e.first ? function(e, i, s) {
					...
					if(r) {
						...
						for(; e = e[n];)
							if(1 === e.nodeType || o) {
								if(c = e[j] || (e[j] = {}), l = c[e.uniqueID] || (c[e.uniqueID] = {}), (a = l[n]) && a[0] === H && a[1] === s) return u[2] = a[2];
				...
				return o && !o[j] && (o = g(o)), s && !s[j] && (s = g(s, r)), n(function(n, r, a, l) {
					...
					if(n) {
						if(s || t) {
							...
							for(u = w.length; u--;)(d = w[u]) && (c = s ? Z(n, d) : h[u]) > -1 && (n[c] = !(r[c] = d))
						}
			...
			function m(t) {
				for(var e, i, n, o = t.length, s = b.relative[t[0].type], r = s || b.relative[" "], a = s ? 1 : 0, l = d(function(t) {
						return t === e
					}, r, !0), c = d(function(t) {
						return Z(e, t) > -1
					...
					if(i = b.relative[t[a].type]) p = [d(h(p), i)];
						...
						if((i = b.filter[t[a].type].apply(null, t[a].matches))[j]) {
							...
							return g(a > 1 && h(p), a > 1 && u(t.slice(0, a - 1).concat({
								value: " " === t[a - 2].type ? "*" : ""
							})).replace(st, "$1"), i, n > a && m(t.slice(a, n)), o > n && m(t = t.slice(n)), o > n && u(t))
						}
						p.push(i)
					}
				return h(p)
				...
				var o = i.length > 0,
					...
					r = function(n, r, a, l, c) {
						var u, d, h, p = 0,
							...
							C = w.length;
						for(c && (S = r === $ || r || c); g !== C && null != (u = w[g]); g++) {
							if(s && u) {
								for(d = 0, r || u.ownerDocument === $ || (N(u), a = !I); h = t[d++];)
									if(h(u, r || $, a)) {
										l.push(u);
										break
									}
			...
			var y, w, b, x, C, T, _, k, S, D, E, N, $, A, I, O, M, P, L, j = "sizzle" + 1 * new Date,
				z = t.document,
				H = 0,
				F = 0,
				W = i(),
			...
			try {
				G.apply(Y = K.call(z.childNodes), z.childNodes), Y[z.childNodes.length].nodeType
			} catch(t) {
				G = {
			...
			w = e.support = {}, C = e.isXML = function(t) {
				...
				return n !== $ && 9 === n.nodeType && n.documentElement ? ($ = n, A = $.documentElement, I = !C($), (i = $.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", bt, !1) : i.attachEvent && i.attachEvent("onunload", bt)), w.attributes = o(function(t) {
					return t.className = "i", !t.getAttribute("className")
				}), w.getElementsByTagName = o(function(t) {
					return t.appendChild($.createComment("")), !t.getElementsByTagName("*").length
				}), w.getElementsByClassName = ft.test($.getElementsByClassName), w.getById = o(function(t) {
					return A.appendChild(t).id = j, !$.getElementsByName || !$.getElementsByName(j).length
				...
				}, M = [], O = [], (w.qsa = ft.test($.querySelectorAll)) && (o(function(t) {
					A.appendChild(t).innerHTML = "<a id='" + j + "'></a><select id='" + j + "-\r\\' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && O.push("[*^$]=" + tt + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || O.push("\\[" + tt + "*(?:value|" + J + ")"), t.querySelectorAll("[id~=" + j + "-]").length || O.push("~="), t.querySelectorAll(":checked").length || O.push(":checked"), t.querySelectorAll("a#" + j + "+*").length || O.push(".#.+[+~]")
				}), o(function(t) {
				...
				})), (w.matchesSelector = ft.test(P = A.matches || A.webkitMatchesSelector || A.mozMatchesSelector || A.oMatchesSelector || A.msMatchesSelector)) && o(function(t) {
					w.disconnectedMatch = P.call(t, "div"), P.call(t, "[s!='']:x"), M.push("!=", nt)
				}), O = O.length && new RegExp(O.join("|")), M = M.length && new RegExp(M.join("|")), e = ft.test(A.compareDocumentPosition), L = e || ft.test(A.contains) ? function(t, e) {
					...
					return i || (1 & (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !w.sortDetached && e.compareDocumentPosition(t) === i ? t === $ || t.ownerDocument === z && L(z, t) ? -1 : e === $ || e.ownerDocument === z && L(z, e) ? 1 : D ? Z(D, t) - Z(D, e) : 0 : 4 & i ? -1 : 1)
				} : function(t, e) {
					if(t === e) return E = !0, 0;
					var i, n = 0,
						o = t.parentNode,
						...
						a = [t],
						l = [e];
					if(!o || !s) return t === $ ? -1 : e === $ ? 1 : o ? -1 : s ? 1 : D ? Z(D, t) - Z(D, e) : 0;
					if(o === s) return r(t, e);
				...
				if((t.ownerDocument || t) !== $ && N(t), i = i.replace(lt, "='$1']"), w.matchesSelector && I && !q[i + " "] && (!M || !M.test(i)) && (!O || !O.test(i))) try {
					var n = P.call(t, i);
					if(n || w.disconnectedMatch || t.document && 11 !== t.document.nodeType) return n
				} catch(t) {}
				return e(i, $, null, [t]).length > 0
			}, e.contains = function(t, e) {
				return(t.ownerDocument || t) !== $ && N(t), L(t, e)
			}, e.attr = function(t, e) {
				(t.ownerDocument || t) !== $ && N(t);
				var i = b.attrHandle[e.toLowerCase()],
					n = i && V.call(b.attrHandle, e.toLowerCase()) ? i(t, e, !I) : void 0;
			...
			return c.prototype = b.filters = b.pseudos, b.setFilters = new c, T = e.tokenize = function(t, i) {
				...
				for(a = t, l = [], c = b.preFilter; a;) {
					...
					for(r in b.filter) !(o = dt[r].exec(a)) || c[r] && !(o = c[r](o)) || (n = o.shift(), s.push({
						value: n,
						type: r,
						matches: o
					}), a = a.slice(n.length));
				...
				var i, n = [],
					...
					s = q[t + " "];
				if(!s) {
					for(e || (e = T(t)), i = e.length; i--;)(s = m(e[i]))[j] ? n.push(s) : o.push(s);
				...
				if(i = i || [], 1 === h.length) {
					if((s = h[0] = h[0].slice(0)).length > 2 && "ID" === (r = s[0]).type && w.getById && 9 === e.nodeType && I && b.relative[s[1].type]) {
					...
					for(o = dt.needsContext.test(t) ? 0 : s.length; o-- && (r = s[o], !b.relative[a = r.type]);)
						if((c = b.find[a]) && (n = c(r.matches[0].replace(yt, wt), mt.test(s[0].type) && l(e.parentNode) || e))) {
							if(s.splice(o, 1), !(t = n.length && u(s))) return G.apply(i, n), i;
							break
						}
				}
				return(d || _(t, h))(n, e, !I, i, !e || mt.test(t) && l(e.parentNode) || e), i
			}, w.sortStable = j.split("").sort(U).join("") === j, w.detectDuplicates = !!E, N(), w.sortDetached = o(function(t) {
		...
		ht.fn.extend({
			...
			closest: function(t, e) {
				for(var i, n = 0, o = this.length, s = [], r = bt.test(t) || "string" != typeof t ? ht(t, e || this.context) : 0; o > n; n++)
			...
			ht.fn[t] = function(i, n) {
				...
				return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (o = ht.filter(n, o)), this.length > 1 && (St[t] || (o = ht.uniqueSort(o)), kt.test(t) && (o = o.reverse())), this.pushStack(o)
			}
		});
		var Dt = /\S+/g;
		ht.Callbacks = function(t) {
				...
				u = {
					add: function() {
						return r && (i && !e && (l = r.length - 1, a.push(i)), function e(i) {
							ht.each(i, function(i, n) {
								ht.isFunction(n) ? t.unique && u.has(n) || r.push(n) : n && n.length && "string" !== ht.type(n) && e(n)
							})
					...
					remove: function() {
						return ht.each(arguments, function(t, e) {
							for(var i;
								(i = ht.inArray(e, r, i)) > -1;) r.splice(i, 1), l >= i && l--
						}), this
					},
					has: function(t) {
			...
			Deferred: function(t) {
				var e = [
							...
							return ht.Deferred(function(i) {
								ht.each(e, function(e, s) {
									...
									o[s[1]](function() {
										...
										t && ht.isFunction(t.promise) ? t.promise().progress(i.notify).done(i.resolve).fail(i.reject) : i[s[0] + "With"](this === n ? i.promise() : this, r ? [t] : arguments)
									})
								}), t = null
							}).promise()
						},
					...
					o = {};
				return n.pipe = n.then, ht.each(e, function(t, s) {
					var r = s[2],
						a = s[3];
			...
			when: function(t) {
				...
				if(r > 1)
					for(e = new Array(r), i = new Array(r), n = new Array(r); r > o; o++) s[o] && ht.isFunction(s[o].promise) ? s[o].promise().progress(c(o, i, e)).done(c(o, n, s)).fail(l.reject) : --a;
		...
		ht.fn.ready = function(t) {
			...
			ready: function(t) {
				(!0 === t ? --ht.readyWait : ht.isReady) || (ht.isReady = !0, !0 !== t && --ht.readyWait > 0 || (Et.resolveWith(it, [ht]), ht.fn.triggerHandler && (ht(it).triggerHandler("ready"), ht(it).off("ready"))))
			}
		}), ht.ready.promise = function(e) {
			if(!Et)
				if(Et = ht.Deferred(), "complete" === it.readyState || "loading" !== it.readyState && !it.documentElement.doScroll) t.setTimeout(ht.ready);
		...
		ht.extend({
				...
				data: function(t, e) {
					...
					if(void 0 === t) {
						if(this.length && (o = ht.data(s), 1 === s.nodeType && !ht._data(s, "parsedAttrs"))) {
							for(i = r.length; i--;) r[i] && 0 === (n = r[i].name).indexOf("data-") && (n = ht.camelCase(n.slice(5)), l(s, n, o[n]));
				...
				promise: function(t, e) {
					...
					for("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;)(i = ht._data(s[r], t + "queueHooks")) && i.empty && (n++, i.empty.add(a));
		...
		ht.event = {
			...
			add: function(t, e, i, n, o) {
				...
				if(m) {
					for(i.handler && (l = i, i = l.handler, o = l.selector), i.guid || (i.guid = ht.guid++), (r = m.events) || (r = m.events = {}), (u = m.handle) || (u = m.handle = function(t) {
							return void 0 === ht || t && ht.event.triggered === t.type ? void 0 : ht.event.dispatch.apply(u.elem, arguments)
						}, u.elem = t), a = (e = (e || "").match(Dt) || [""]).length; a--;) s = Gt.exec(e[a]) || [], p = g = s[1], f = (s[2] || "").split(".").sort(), p && (c = ht.event.special[p] || {}, p = (o ? c.delegateType : c.bindType) || p, c = ht.event.special[p] || {}, d = ht.extend({
						type: p,
						origType: g,
						data: n,
						handler: i,
						...
						namespace: f.join(".")
					}, l), (h = r[p]) || (h = r[p] = [], h.delegateCount = 0, c.setup && !1 !== c.setup.call(t, n, f, u) || (t.addEventListener ? t.addEventListener(p, u, !1) : t.attachEvent && t.attachEvent("on" + p, u))), c.add && (c.add.call(t, d), d.handler.guid || (d.handler.guid = i.guid)), o ? h.splice(h.delegateCount++, 0, d) : h.push(d), ht.event.global[p] = !0);
					t = null
				}
			},
				...
				if(m && (u = m.events)) {
					for(c = (e = (e || "").match(Dt) || [""]).length; c--;)
						if(a = Gt.exec(e[c]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
							for(d = ht.event.special[p] || {}, h = u[p = (n ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = s = h.length; s--;) r = h[s], !o && g !== r.origType || i && i.guid !== r.guid || a && !a.test(r.namespace) || n && n !== r.selector && ("**" !== n || !r.selector) || (h.splice(s, 1), r.selector && h.delegateCount--, d.remove && d.remove.call(t, r));
			...
			trigger: function(e, i, n, o) {
				var s, r, a, l, c, u, d, h = [n || it],
					p = ct.call(e, "type") ? e.type : e,
					f = ct.call(e, "namespace") ? e.namespace.split(".") : [];
				if(a = u = n = n || it, 3 !== n.nodeType && 8 !== n.nodeType && !Qt.test(p + ht.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), r = p.indexOf(":") < 0 && "on" + p, e = e[ht.expando] ? e : new ht.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : ht.makeArray(i, [e]), c = ht.event.special[p] || {}, o || !c.trigger || !1 !== c.trigger.apply(n, i))) {
					if(!o && !c.noBubble && !ht.isWindow(n)) {
						for(l = c.delegateType || p, Qt.test(l + p) || (a = a.parentNode); a; a = a.parentNode) h.push(a), u = a;
						u === (n.ownerDocument || it) && h.push(u.defaultView || u.parentWindow || t)
					}
					for(d = 0;
						(a = h[d++]) && !e.isPropagationStopped();) e.type = d > 1 ? l : c.bindType || p, (s = (ht._data(a, "events") || {})[e.type] && ht._data(a, "handle")) && s.apply(a, i), (s = r && a[r]) && s.apply && $t(a) && (e.result = s.apply(a, i), !1 === e.result && e.preventDefault());
					if(e.type = p, !o && !e.isDefaultPrevented() && (!c._default || !1 === c._default.apply(h.pop(), i)) && $t(n) && r && n[p] && !ht.isWindow(n)) {
						(u = n[r]) && (n[r] = null), ht.event.triggered = p;
						try {
							n[p]()
						} catch(t) {}
						ht.event.triggered = void 0, u && (n[r] = u)
					}
					return e.result
				}
			},
				...
				if(a[0] = t, t.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, t)) {
					for(r = ht.event.handlers.call(this, t, l), e = 0;
						...
						for(t.currentTarget = o.elem, i = 0;
							(s = o.handlers[i++]) && !t.isImmediatePropagationStopped();) t.rnamespace && !t.rnamespace.test(s.namespace) || (t.handleObj = s, t.data = s.data, void 0 !== (n = ((ht.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, a)) && !1 === (t.result = n) && (t.preventDefault(), t.stopPropagation()));
				...
				if(a && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1))
					for(; l != this; l = l.parentNode || this)
						if(1 === l.nodeType && (!0 !== l.disabled || "click" !== t.type)) {
							for(n = [], i = 0; a > i; i++) s = e[i], o = s.selector + " ", void 0 === n[o] && (n[o] = s.needsContext ? ht(o, this).index(l) > -1 : ht.find(o, this, null, [l]).length), n[o] && n.push(s);
							n.length && r.push({
								elem: l,
								handlers: n
							})
			...
			fix: function(t) {
				...
				var e, i, n, o = t.type,
					s = t,
					r = this.fixHooks[o];
				for(r || (this.fixHooks[o] = r = Xt.test(o) ? this.mouseHooks : Yt.test(o) ? this.keyHooks : {}), n = r.props ? this.props.concat(r.props) : this.props, t = new ht.Event(s), e = n.length; e--;) i = n[e], t[i] = s[i];
				return t.target || (t.target = s.srcElement || it), 3 === t.target.nodeType && (t.target = t.target.parentNode), t.metaKey = !!t.metaKey, r.filter ? r.filter(t, s) : t
			},
			...
			setup: function() {
				return Vt.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (ht.event.add(this, "propertychange._change", function(t) {
					...
					var e = t.target;
					Vt.test(e.nodeName) && !ht._data(e, "change") && (ht.event.add(e, "change._change", function(t) {
			...
			teardown: function() {
				return ht.event.remove(this, "._change"), !Vt.test(this.nodeName)
			}
		}), ut.focusin || ht.each({
			focus: "focusin",
			blur: "focusout"
		...
		ht.extend({
			...
			clone: function(t, e, i) {
				var n, o, s, r, a, l = ht.contains(t.ownerDocument, t);
				...
				return(n = f(s, "script")).length > 0 && g(n, !l && f(t, "script")), n = a = o = null, s
			},
			cleanData: function(t, e) {
				for(var i, n, o, s, r = 0, a = ht.expando, l = ht.cache, c = ut.attributes, u = ht.event.special; null != (i = t[r]); r++)
					if((e || $t(i)) && (o = i[a], s = o && l[o])) {
						if(s.events)
							for(n in s.events) u[n] ? ht.event.remove(i, n) : ht.removeEvent(i, n, s.handle);
			...
			html: function(t) {
				return jt(this, function(t) {
					...
					if("string" == typeof t && !te.test(t) && (ut.htmlSerialize || !Zt.test(t)) && (ut.leadingWhitespace || !Wt.test(t)) && !qt[(Ht.exec(t) || ["", ""])[1].toLowerCase()]) {
			...
			ht.fn[t] = function(t) {
				for(var i, n = 0, o = [], s = ht(t), r = s.length - 1; r >= n; n++) i = n === r ? this : this.clone(!0), ht(s[n])[e](i), st.apply(o, i.get());
		...
		! function() {
			function e() {
				...
				d.appendChild(l), c.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", i = o = a = !1, n = r = !0, t.getComputedStyle && (u = t.getComputedStyle(c), i = "1%" !== (u || {}).top, a = "2px" === (u || {}).marginLeft, o = "4px" === (u || {
					width: "4px"
		...
		t.getComputedStyle ? (de = function(e) {
			...
			return i = i || de(t), "" !== (r = i ? i.getPropertyValue(e) || i[e] : void 0) && void 0 !== r || ht.contains(t.ownerDocument, t) || (r = ht.style(t, e)), i && !ut.pixelMarginRight() && le.test(r) && ae.test(e) && (n = a.width, o = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = i.width, a.width = n, a.minWidth = o, a.maxWidth = s), void 0 === r ? r : r + ""
		}) : ue.currentStyle && (de = function(t) {
			return t.currentStyle
		}, he = function(t, e, i) {
			var n, o, s, r, a = t.style;
			return i = i || de(t), null == (r = i ? i[e] : void 0) && a && a[e] && (r = a[e]), le.test(r) && !pe.test(e) && (n = a.left, o = t.runtimeStyle, (s = o && o.left) && (o.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em" : r, r = a.pixelLeft + "px", a.left = n, s && (o.left = s)), void 0 === r ? r : r + "" || "auto"
		});
		var fe = /alpha\([^)]*\)/i,
			ge = /opacity\s*=\s*([^)]*)/i,
			me = /^(none|table(?!-c[ea]).+)/,
		...
		ht.extend({
			...
			style: function(t, e, i, n) {
				if(t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
					var o, s, r, a = ht.camelCase(e),
						l = t.style;
					if(e = ht.cssProps[a] || (ht.cssProps[a] = I(a) || a), r = ht.cssHooks[e] || ht.cssHooks[a], void 0 === i) return r && "get" in r && void 0 !== (o = r.get(t, !1, n)) ? o : l[e];
					if("string" === (s = typeof i) && (o = Mt.exec(i)) && o[1] && (i = h(t, e, o), s = "number"), null != i && i === i && ("number" === s && (i += o && o[3] || (ht.cssNumber[a] ? "" : "px")), ut.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(r && "set" in r && void 0 === (i = r.set(t, i, n))))) try {
						l[e] = i
					} catch(t) {}
				}
			},
			css: function(t, e, i, n) {
				var o, s, r, a = ht.camelCase(e);
				return e = ht.cssProps[a] || (ht.cssProps[a] = I(a) || a), (r = ht.cssHooks[e] || ht.cssHooks[a]) && "get" in r && (s = r.get(t, !0, i)), void 0 === s && (s = he(t, e, n)), "normal" === s && e in we && (s = we[e]), "" === i || i ? (o = parseFloat(s), !0 === i || isFinite(o) ? o || 0 : s) : s
			}
			...
			ht.cssHooks[e] = {
				...
				set: function(t, i, n) {
					var o = n && de(t);
					return M(0, i, n ? P(t, e, n, ut.boxSizing && "border-box" === ht.css(t, "boxSizing", !1, o), o) : 0)
				}
			}
			...
			set: function(t, e) {
				...
				i.zoom = 1, (e >= 1 || "" === e) && "" === ht.trim(s.replace(fe, "")) && i.removeAttribute && (i.removeAttribute("filter"), "" === e || n && !n.filter) || (i.filter = fe.test(s) ? s.replace(fe, o) : s + " " + o)
			}
		}), ht.cssHooks.marginRight = A(ut.reliableMarginRight, function(t, e) {
			return e ? ce(t, {
				display: "inline-block"
			}, he, [t, "marginRight"]) : void 0
		}), ht.cssHooks.marginLeft = A(ut.reliableMarginLeft, function(t, e) {
			...
			ht.cssHooks[t + e] = {
				expand: function(i) {
					for(var n = 0, o = {}, s = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) o[t + Pt[n] + e] = s[n] || s[n - 2] || s[0];
					return o
				}
			}, ae.test(t) || (ht.cssHooks[t + e].set = M)
		}), ht.fn.extend({
			css: function(t, e) {
				return jt(this, function(t, e, i) {
					var n, o, s = {},
						r = 0;
					if(ht.isArray(e)) {
						for(n = de(t), o = e.length; o > r; r++) s[e[r]] = ht.css(t, e[r], !1, n);
						return s
					}
		...
		ht.Animation = ht.extend(R, {
				...
				prefilters: [function(t, e, i) {
					...
					})), 1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [h.overflow, h.overflowX, h.overflowY], "inline" === ("none" === (c = ht.css(t, "display")) ? ht._data(t, "olddisplay") || $(t.nodeName) : c) && "none" === ht.css(t, "float") && (ut.inlineBlockNeedsLayout && "inline" !== $(t.nodeName) ? h.zoom = 1 : h.display = "inline-block")), i.overflow && (h.overflow = "hidden", ut.shrinkWrapBlocks() || u.always(function() {
					...
					if(ht.isEmptyObject(d)) "inline" === ("none" === c ? $(t.nodeName) : c) && (h.display = c);
					else {
						...
						for(n in d) r = F(p ? f[n] : 0, n, u), n in f || (f[n] = r.start, p && (r.end = r.start, r.start = "width" === n || "height" === n ? 1 : 0))
					}
				}],
			...
			valHooks: {
				option: {
					get: function(t) {
						...
						return null != e ? e : ht.trim(ht.text(t)).replace(De, " ")
					}
				},
				select: {
					get: function(t) {
					...
					set: function(t, e) {
						for(var i, n, o = t.options, s = ht.makeArray(e), r = o.length; r--;)
							if(n = o[r], ht.inArray(ht.valHooks.option.get(n), s) > -1) try {
								n.selected = i = !0
							} catch(t) {
								n.scrollHeight
							} else n.selected = !1;
		...
		var Ee, Ne, $e = ht.expr.attrHandle,
			Ae = /^(?:checked|selected)$/i,
			Ie = ut.getSetAttribute,
			Oe = ut.input;
		ht.fn.extend({
			attr: function(t, e) {
			...
			attr: function(t, e, i) {
				var n, o, s = t.nodeType;
				if(3 !== s && 8 !== s && 2 !== s) return void 0 === t.getAttribute ? ht.prop(t, e, i) : (1 === s && ht.isXMLDoc(t) || (e = e.toLowerCase(), o = ht.attrHooks[e] || (ht.expr.match.bool.test(e) ? Ne : Ee)), void 0 !== i ? null === i ? void ht.removeAttr(t, e) : o && "set" in o && void 0 !== (n = o.set(t, i, e)) ? n : (t.setAttribute(e, i + ""), i) : o && "get" in o && null !== (n = o.get(t, e)) ? n : null == (n = ht.find.attr(t, e)) ? void 0 : n)
			},
			attrHooks: {
				type: {
					set: function(t, e) {
			...
			removeAttr: function(t, e) {
				var i, n, o = 0,
					s = e && e.match(Dt);
				if(s && 1 === t.nodeType)
					for(; i = s[o++];) n = ht.propFix[i] || i, ht.expr.match.bool.test(i) ? Oe && Ie || !Ae.test(i) ? t[n] = !1 : t[ht.camelCase("default-" + i)] = t[n] = !1 : ht.attr(t, i, ""), t.removeAttribute(Ie ? i : n)
			}
		}), Ne = {
			set: function(t, e, i) {
				return !1 === e ? ht.removeAttr(t, i) : Oe && Ie || !Ae.test(i) ? t.setAttribute(!Ie && ht.propFix[i] || i, i) : t[ht.camelCase("default-" + i)] = t[i] = !0, i
			}
		}, ht.each(ht.expr.match.bool.source.match(/\w+/g), function(t, e) {
			var i = $e[e] || ht.find.attr;
			Oe && Ie || !Ae.test(e) ? $e[e] = function(t, e, n) {
				var o, s;
				return n || (s = $e[e], $e[e] = o, o = null != i(t, e, n) ? e.toLowerCase() : null, $e[e] = s), o
			} : $e[e] = function(t, e, i) {
				return i ? void 0 : t[ht.camelCase("default-" + e)] ? e.toLowerCase() : null
			}
		}), Oe && Ie || (ht.attrHooks.value = {
			set: function(t, e, i) {
				return ht.nodeName(t, "input") ? void(t.defaultValue = e) : Ee && Ee.set(t, e, i)
			}
		}), Ie || (Ee = {
			set: function(t, e, i) {
			...
			propHooks: {
				tabIndex: {
					get: function(t) {
						...
						return e ? parseInt(e, 10) : Me.test(t.nodeName) || Pe.test(t.nodeName) && t.href ? 0 : -1
					}
				}
			},
			propFix: {
		...
		ht.fn.extend({
			addClass: function(t) {
				...
				if("string" == typeof t && t)
					for(e = t.match(Dt) || []; i = this[l++];)
						if(o = q(i), n = 1 === i.nodeType && (" " + o + " ").replace(Le, " ")) {
			...
			toggleClass: function(t, e) {
				...
				return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ht.isFunction(t) ? this.each(function(i) {
					...
					var e, n, o, s;
					if("string" === i)
						for(n = 0, o = ht(this), s = t.match(Dt) || []; e = s[n++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
			...
			hasClass: function(t) {
				var e, i, n = 0;
				for(e = " " + t + " "; i = this[n++];)
					if(1 === i.nodeType && (" " + q(i) + " ").replace(Le, " ").indexOf(e) > -1) return !0;
				return !1
			}
		...
		ht.parseJSON = function(e) {
			...
			var i, n = null,
				o = ht.trim(e + "");
			return o && !ht.trim(o.replace(Fe, function(t, e, o, s) {
		...
		ht.extend({
			...
			ajaxSetup: function(t, e) {
				return e ? V(V(t, ht.ajaxSettings), e) : V(ht.ajaxSettings, t)
			},
			ajaxPrefilter: U(Xe),
			ajaxTransport: U(Qe),
			ajax: function(e, i) {
				function n(e, i, n, o) {
					var s, d, y, w, x, T = i;
					2 !== b && (b = 2, l && t.clearTimeout(l), u = void 0, a = o || "", C.readyState = e > 0 ? 4 : 0, s = e >= 200 && 300 > e || 304 === e, n && (w = Y(h, C, n)), w = X(h, w, C, s), s ? (h.ifModified && ((x = C.getResponseHeader("Last-Modified")) && (ht.lastModified[r] = x), (x = C.getResponseHeader("etag")) && (ht.etag[r] = x)), 204 === e || "HEAD" === h.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = w.state, d = w.data, y = w.error, s = !y)) : (y = T, !e && T || (T = "error", 0 > e && (e = 0))), C.status = e, C.statusText = (i || T) + "", s ? g.resolveWith(p, [d, T, C]) : g.rejectWith(p, [C, T, y]), C.statusCode(v), v = void 0, c && f.trigger(s ? "ajaxSuccess" : "ajaxError", [C, h, s ? d : y]), m.fireWith(p, [C, T]), c && (f.trigger("ajaxComplete", [C, h]), --ht.active || ht.event.trigger("ajaxStop")))
				}
				"object" == typeof e && (i = e, e = void 0), i = i || {};
				var o, s, r, a, l, c, u, d, h = ht.ajaxSetup({}, i),
					p = h.context || h,
		...
		ht.param = function(t, e) {
			...
			return this.isLocal ? J() : it.documentMode > 8 ? Z() : /^(get|post|head|put|delete|options)$/i.test(this.type) && Z() || J()
		} : Z;
		var oi = 0,
			si = {},
			ri = ht.ajaxSettings.xhr();
		t.attachEvent && t.attachEvent("onunload", function() {
			for(var t in si) si[t](void 0, !0)
		}), ut.cors = !!ri && "withCredentials" in ri, (ri = ut.ajax = !!ri) && ht.ajaxTransport(function(e) {
					...
					send: function(n, o) {
						...
						r.send(e.hasContent && e.data || null), i = function(t, n) {
							...
							if(i && (n || 4 === r.readyState))
								if(delete si[a], i = void 0, r.onreadystatechange = ht.noop, n) 4 !== r.readyState && r.abort();
								else {
		...
		ht.ajaxSetup({
			...
			return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = ht.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(li, "$1" + o) : !1 !== e.jsonp && (e.url += (He.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
				...
				void 0 === s ? ht(t).removeProp(o) : t[o] = s, e[o] && (e.jsonpCallback = i.jsonpCallback, ai.push(o)), r && ht.isFunction(s) && s(r[0]), r = s = void 0
			}), "script") : void 0
		...
		ht.fn.load = function(t, e, i) {
			...
			var n, o, s, r = this,
				a = t.indexOf(" ");
			return a > -1 && (n = ht.trim(t.slice(a, t.length)), t = t.slice(0, a)), ht.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (o = "POST"), r.length > 0 && ht.ajax({
				url: t,
				type: o || "GET",
				dataType: "html",
				data: e
			...
			setOffset: function(t, e, i) {
				var n, o, s, r, a, l, c = ht.css(t, "position"),
					u = ht(t),
					d = {};
			...
			offset: function(t) {
				...
				var e, i, n = {
					...
					o = this[0],
					s = o && o.ownerDocument;
				return s ? (e = s.documentElement, ht.contains(e, o) ? (void 0 !== o.getBoundingClientRect && (n = o.getBoundingClientRect()), i = tt(s), {
			...
			ht.fn[t] = function(n) {
				return jt(this, function(t, n, o) {
					var s = tt(t);
					return void 0 === o ? s ? e in s ? s[e] : s.document.documentElement[n] : t[n] : void(s ? s.scrollTo(i ? ht(s).scrollLeft() : o, i ? o : ht(s).scrollTop()) : t[n] = o)
				}, t, n, arguments.length, null)
			}
		}), ht.each(["top", "left"], function(t, e) {
			ht.cssHooks[e] = A(ut.pixelPosition, function(t, i) {
			...
			ht.each({
				...
				ht.fn[n] = function(n, o) {
					...
					return jt(this, function(e, i, n) {
						var o;
						return ht.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === n ? ht.css(e, i, r) : ht.style(e, i, n, r)
					}, e, s ? n : void 0, s, null)
				}
			})
		}), ht.fn.extend({
		...
		o.prototype = {
			...
			_findParticles: function() {
				...
				this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
					var i, o, s, r, a, l, c, u, d, h = t(this),
						p = 0,
						f = 0,
						g = 0,
						m = 0;
				...
				directionNav: {
					setup: function() {
						...
						o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + r + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + r + "direction-nav li a", o)), m.directionNav.update(), o.directionNav.bind(c, function(e) {
							e.preventDefault();
							var i;
							("" === u || u === e.type) && (i = t(this).hasClass(r + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(i, o.vars.pauseOnAction)), "" === u && (u = e.type), m.setToClearWatchedEvent()
						})
					},
					update: function() {
						var t = r + "disabled";
					...
					a ? (i.style.msTouchAction = "none", i._gesture = new MSGesture, i._gesture.target = i, i.addEventListener("MSPointerDown", function(t) {
						...
						if(e) {
							...
							return w += d ? a : o, r = w, m = d ? Math.abs(w) < Math.abs(-o) : Math.abs(w) < Math.abs(-a), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
								i._gesture.stop()
							}) : void((!m || Number(new Date) - l > 500) && (t.preventDefault(), !f && e.transitions && (e.vars.animationLoop || (r = w / (0 === e.currentSlide && 0 > w || e.currentSlide === e.last && w > 0 ? Math.abs(w) / s + 2 : 1)), e.setProps(n + r, "setTouch"))))
						}
						...
						v = i.touches[0].pageX, y = i.touches[0].pageY, r = d ? t - y : t - v;
						(!(m = d ? Math.abs(r) < Math.abs(v - e) : Math.abs(r) < Math.abs(y - e)) || Number(new Date) - l > 500) && (i.preventDefault(), !f && o.transitions && (o.vars.animationLoop || (r /= 0 === o.currentSlide && 0 > r || o.currentSlide === o.last && r > 0 ? Math.abs(r) / s + 2 : 1), o.setProps(n + r, "setTouch")))
					}, g = function(a) {
						if(i.removeEventListener("touchmove", u, !1), o.animatingTo === o.currentSlide && !m && null !== r) {
							var c = h ? -r : r,
						...
						i.removeEventListener("touchend", g, !1), t = null, e = null, r = null, n = null
		...
		e.DEFAULTS = {
			...
			return this.each(function() {
				...
				s && (o && o.stop(), n.data("countTo", o = new e(this, r))), o[a].call(o)
			})
		}
	}), function(t) {
		function e(e) {
		...
		t.expr[":"].appeared = function(e) {
			...
			var n = l.scrollLeft(),
				...
				r = s.left,
				a = s.top;
			return a + i.height() >= o && a - (i.data("appear-top-offset") || 0) <= o + l.height() && r + i.width() >= n && r - (i.data("appear-left-offset") || 0) <= n + l.width()
		}, t.fn.extend({
			appear: function(e) {
				var o = t.extend({}, a, e || {}),
				...
				if(!s) {
					var c = function() {
						r || (r = !0, setTimeout(i, o.interval))
					};
					t(window).scroll(c).resize(c), s = !0
				}
		...
		y.prototype = {
			...
			open: function(i) {
				...
				if(!1 === i.isObj) {
					...
					for(s = 0; l.length > s; s++)
						if((a = l[s]).parsed && (a = a.el[0]), a === i.el[0]) {
							e.index = s;
							break
						}
			...
			updateItemHTML: function() {
				...
				e.appendContent(r, n), i.preloaded = !0, T(h, i), s = i.type, e.container.prepend(e.contentContainer), T("AfterChange")
			},
		...
		var D, E, N, $ = "inline",
			A = function() {
				N && (E.after(N.addClass(D)).detach(), N = null)
			};
				...
				getInline: function(i, n) {
					if(A(), i.src) {
						...
						if(s.length) {
							...
							r && r.tagName && (E || (D = o.hiddenClass, E = C(D), D = "mfp-" + D), N = s.after(E).detach().removeClass(D)), e.updateStatus("ready")
		...
		t.magnificPopup.registerModule(O, {
			...
			proto: {
				initAjax: function() {
					e.types.push(O), I = e.st.ajax.cursor, x(l + "." + O, P), x("BeforeChange." + O, P)
				},
				getAjax: function(i) {
					I && n.addClass(I), e.updateStatus("loading");
					var o = t.extend({
						url: i.src,
						success: function(n, o, s) {
							...
							T("ParseAjax", r), e.appendContent(t(r.data), O), i.finished = !0, M(), e._setFocus(), setTimeout(function() {
								e.wrap.addClass(g)
		...
		t.magnificPopup.registerModule("image", {
			...
			proto: {
				...
				getImage: function(i, n) {
					var o = 0,
						s = function() {
							i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, T("ImageLoadComplete")) : 200 > ++o ? setTimeout(s, 100) : r())
						},
						r = function() {
					...
					if(l.length) {
						...
						c.className = "mfp-img", i.img = t(c).on("load.mfploader", s).on("error.mfploader", r), c.src = i.src, l.is("img") && (i.img = i.img.clone()), (c = i.img[0]).naturalWidth > 0 ? i.hasSize = !0 : c.width || (i.hasSize = !1)
					}
		...
		t.magnificPopup.registerModule("gallery", {
			...
			proto: {
				initGallery: function() {
					...
					return e.direction = !0, !(!i || !i.enabled) && (r += " mfp-gallery", x(d + n, function() {
						...
						if(e) {
							...
							r.on("touchstart" + n, function(t) {
								u = !1, h = 1, d = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], l = d.clientX, c = d.clientY, b.on("touchmove" + n, function(t) {
									...
									i(), u || h > 1 || (s = !0, t.preventDefault(), clearTimeout(a), a = setTimeout(function() {
										s = !1
									}, 1e3), o())
								})
							})
		...
		n.Defaults = {
			...
			return e.wrap('<div class="owl-video-wrapper"' + r + "></div>"), this._core.settings.lazyLoad && (l = "data-src", c = "owl-lazy"), a.length ? (d(a.attr(l)), a.remove(), !1) : void("youtube" === i.type ? (s = "http://img.youtube.com/vi/" + i.id + "/hqdefault.jpg", d(s)) : "vimeo" === i.type && t.ajax({
				type: "GET",
		...
		e.Defaults = {
			...
			if("page" !== i.slideBy && (i.slideBy = Math.min(i.slideBy, i.items)), i.dots || "page" == i.slideBy)
				for(this._pages = [], t = n, e = 0, 0; o > t; t++)(e >= s || 0 === e) && (this._pages.push({
					start: t - n,
					end: t - n + s - 1
...
function(t, e) {
	...
	function s(e, i) {
		...
		for(var r in n) i.test(r) && (o[r.replace(s, function(t, e) {
	...
	c.prototype = {
		...
		_applyEvents: function(t) {
			for(var e, i, n, o = 0; o < t.length; o++) e = t[o][0], 2 === t[o].length ? (i = void 0, n = t[o][1]) : 3 === t[o].length && (i = t[o][1], n = t[o][2]), e.on(n, i)
		},
		_unapplyEvents: function(t) {
			for(var e, i, n, o = 0; o < t.length; o++) e = t[o][0], 2 === t[o].length ? (n = void 0, i = t[o][1]) : 3 === t[o].length && (n = t[o][1], i = t[o][2]), e.off(i, n)
		},
		...
		place: function() {
			if(!this.isInline) {
				var e = this.picker.outerWidth(),
					...
					d = l.left,
					h = l.top;
				this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"), "auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x), "right" === this.o.orientation.x && (d -= e - u)) : (this.picker.addClass("datepicker-orient-left"), l.left < 0 ? d -= l.left - 10 : l.left + e > n && (d = n - e - 10));
				var p, f, g = this.o.orientation.y;
				"auto" === g && (p = -s + l.top - i, f = s + o - (l.top + c + i), g = Math.max(p, f) === f ? "top" : "bottom"), this.picker.addClass("datepicker-orient-" + g), "top" === g ? h += c : h -= i + parseInt(this.picker.css("padding-top")), this.picker.css({
					top: h,
					left: d,
					zIndex: r
				})
		...
		fill: function() {
			...
			this.picker.find(".datepicker-days thead th.datepicker-switch").text(f[this.o.language].months[s] + " " + o), this.picker.find("tfoot th.today").text(u).toggle(!1 !== this.o.todayBtn), this.picker.find("tfoot th.clear").text(d).toggle(!1 !== this.o.clearBtn), this.updateNavArrows(), this.fillMonths();
			var h = i(o, s - 1, 28),
				p = g.getDaysInMonth(h.getUTCFullYear(), h.getUTCMonth());
			h.setUTCDate(p), h.setUTCDate(p - (h.getUTCDay() - this.o.weekStart + 7) % 7);
			var m = new Date(h);
			m.setUTCDate(m.getUTCDate() + 42), m = m.valueOf();
			for(var v, y = []; h.valueOf() < m;) {
				if(h.getUTCDay() === this.o.weekStart && (y.push("<tr>"), this.o.calendarWeeks)) {
					var w = new Date(+h + (this.o.weekStart - h.getUTCDay() - 7) % 7 * 864e5),
				...
				if((v = this.getClassNames(h)).push("day"), this.o.beforeShowDay !== t.noop) {
					var T = this.o.beforeShowDay(this._utc_to_local(h));
					void 0 === T ? T = {} : "boolean" == typeof T ? T = {
						enabled: T
					} : "string" == typeof T && (T = {
						classes: T
					}), !1 === T.enabled && v.push("disabled"), T.classes && (v = v.concat(T.classes.split(/\s+/))), T.tooltip && (e = T.tooltip)
				}
				v = t.unique(v), y.push('<td class="' + v.join(" ") + '"' + (e ? ' title="' + e + '"' : "") + ">" + h.getUTCDate() + "</td>"), h.getUTCDay() === this.o.weekEnd && y.push("</tr>"), h.setUTCDate(h.getUTCDate() + 1)
			}
			...
			}), (o < r || o > l) && _.addClass("disabled"), o === r && _.slice(0, a).addClass("disabled"), o === l && _.slice(c + 1).addClass("disabled"), y = "", o = 10 * parseInt(o / 10, 10);
			var k = this.picker.find(".datepicker-years").find("th:eq(1)").text(o + "-" + (o + 9)).end().find("td");
			o -= 1;
			for(var S, D = t.map(this.dates, function(t) {
					return t.getUTCFullYear()
				}), E = -1; E < 11; E++) S = ["year"], -1 === E ? S.push("old") : 10 === E && S.push("new"), -1 !== t.inArray(o, D) && S.push("active"), (o < r || o > l) && S.push("disabled"), y += '<span class="' + S.join(" ") + '">' + o + "</span>", o += 1;
			k.html(y)
		},
			...
			if(1 === r.length) switch(r[0].nodeName.toLowerCase()) {
				case "th":
					switch(r[0].className) {
						...
						case "prev":
						case "next":
							var a = g.modes[this.viewMode].navStep * ("prev" === r[0].className ? -1 : 1);
							switch(this.viewMode) {
								case 0:
		...
		moveMonth: function(t, e) {
			if(t) {
				...
				}, i = r + e, o.setUTCMonth(i), (i < 0 || i > 11) && (i = (i + 12) % 12);
				else {
	...
	t.fn.datepicker = function(e) {
		...
		return this.each(function() {
			...
			if(!a) {
				var d = s(this, "date"),
					p = r(t.extend({}, h, d, l).language),
					f = t.extend({}, h, p, d, l);
				if(o.is(".input-daterange") || f.inputs) {
					var g = {
						inputs: f.inputs || o.find("input").toArray()
					};
					o.data("datepicker", a = new u(this, t.extend(f, g)))
				} else o.data("datepicker", a = new c(this, f))
			}
			...
			parseDate: function(e, n, o) {
				...
				if(e) {
					...
					if(/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(e)) {
						for(e = new Date, l = 0; l < d.length; l++) switch(r = u.exec(d[l]), a = parseInt(r[1]), r[2]) {
							case "d":
								e.setUTCDate(e.getUTCDate() + a);
								break;
							case "m":
								e = c.prototype.moveMonth.call(c.prototype, e, a);
								break;
							case "w":
								e.setUTCDate(e.getUTCDate() + 7 * a);
								break;
							case "y":
								e = c.prototype.moveYear.call(c.prototype, e, a)
						}
					...
					if(d.length !== w.length && (w = t(w).filter(function(e, i) {
						...
						for(l = 0, b = w.length; l < b; l++) {
							if(h = parseInt(d[l], 10), r = w[l], isNaN(h)) switch(r) {
								case "MM":
									p = t(f[o].months).filter(s), h = t.inArray(p[0], f[o].months) + 1;
									break;
								case "M":
									p = t(f[o].monthsShort).filter(s), h = t.inArray(p[0], f[o].monthsShort) + 1
							}
							m[r] = h
						}
						var x, C;
						for(l = 0; l < v.length; l++)(C = v[l]) in m && !isNaN(m[C]) && (x = new Date(e), y[C](x, m[C]), isNaN(x) || (e = x))
					}
					return e
				}
			},
