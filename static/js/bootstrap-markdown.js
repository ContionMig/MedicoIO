            ...
            [{
                ...
                data: [{
                    ...
                    callback: function(e) {
                        ...
                        if (content.substr(selected.start - 4, 4) === "<h3>" && content.substr(selected.end, 5) === "</h3>") {
                            e.setSelection(selected.start - 4, selected.end + 5);
                            e.replaceSelection(chunk);
                            cursor = selected.start - 5
                        } else {
                            e.replaceSelection("<h3>" + chunk + "</h3>");
                ...
                data: [{
                    ...
                    callback: function(e) {
                        ...
                        if (link !== null && link !== "" && link !== "http://" && urlRegex.test(link)) {
                            var sanitizedLink = $("<div>" + link + "</div>").text();
                            e.replaceSelection("<img width='100%' src=" + sanitizedLink + " alt=" + chunk + ">");
